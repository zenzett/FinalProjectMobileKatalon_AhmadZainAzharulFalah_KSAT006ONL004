...
Mobile.tap(findTestObject('Object Repository/Dashboard/android.widget.Button - ADD ACCOUNT'), 0)
...
Mobile.tap(findTestObject('Object Repository/Dashboard/android.widget.TextView - Welcome to Bank App'), 
    0)
